   ...
   if($select_user->rowCount() > 0){
      ...
      if($pass != $cpass){
         ...
         if($select_user->rowCount() > 0){
            ...
            $_SESSION['success_message'] = 'Đăng ký tài khoản thành công!';
...
<section class="form-container">
   ...
   <form action="" method="post">
      <h3>Đăng ký</h3>
      <input type="text" name="name" required placeholder="Họ tên" class="box" maxlength="50">
      <input type="email" name="email" required placeholder="Email" class="box" maxlength="50" oninput="this.value = this.value.replace(/\s/g, '')">
      <input type="tel" name="number" required placeholder="Số điện thoại" class="box" pattern="[0-9]{10}" maxlength="10">
