...
<section class="category">
   ...
   <h1 class="title">Loại đồ ăn</h1>

   <div class="box-container">

      <a href="category.php?category=Đồ ăn nhanh" class="box">
         <img src="images/cat-1.png" alt="">
         <h3>Đồ ăn nhanh</h3>
      </a>

      <a href="category.php?category=Món chính" class="box">
...
<section class="products">
   ...
   <h1 class="title">Món ăn hiện có</h1>
   ...
   <div class="box-container">
      ...
      <form action="" method="post" class="box">
         ...
         <div class="flex">
            <div class="price"><?= number_format($fetch_products['price']); ?><span> VNĐ</span></div>
