...
<section class="form-container">
   ...
   <form action="" method="post">
      <h3>Đăng nhập</h3>
      <input type="email" name="email" required placeholder="Email" class="box" maxlength="50" oninput="this.value = this.value.replace(/\s/g, '')"> <!--loại bỏ khoảng trắng khi nhập form -->
