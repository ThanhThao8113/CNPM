...
<section class="update-product">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <input type="text" required placeholder="Nhập tên món" name="name" maxlength="100" class="box" value="<?= $fetch_products['name']; ?>">
      ...
      <span>Cập nhật mô tả món ăn</span>
      <input class="box" required placeholder="Nhập mô tả món" name="description" maxlength="500" value="<?= $fetch_products['description']; ?>"></input>
      <span>Cập nhật loại đồ ăn</span>
