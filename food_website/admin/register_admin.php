...
<section class="form-container">
   ...
   <form action="" method="POST">
      ...
      <input type="password" name="cpass" maxlength="20" required placeholder="Xác nhật mật khẩu" class="box" oninput="this.value = this.value.replace(/\s/g, '')">
