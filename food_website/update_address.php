...
<section class="form-container">
   ...
   <form action="" method="post">
      ...
      <!-- <input type="text" class="box" placeholder="Căn hộ số" required maxlength="50" name="flat"> -->
      <input type="text" class="box" placeholder="Chi tiết" required maxlength="50" name="building">
      <input type="text" class="box" placeholder="Phường" required maxlength="50" name="area">
